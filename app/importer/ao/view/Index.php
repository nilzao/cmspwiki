<?php
class app_importer_ao_view_Index {
	private static $instance;
	private $bean;
	private $viewArray;
	
	private function __construct(app_importer_bean_view_Index $bean){
		$this->bean = $bean;
		$this->setViewArray();
	}

	public static function getInstance(app_importer_bean_view_Index $bean) {
