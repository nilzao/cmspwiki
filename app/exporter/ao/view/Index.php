<?php
class app_exporter_ao_view_Index {
	private static $instance;
	private $bean;
	private $viewArray;
	
	private function __construct(app_exporter_bean_view_Index $bean){
		$this->bean = $bean;
		$this->setViewArray();
	}

	public static function getInstance(app_exporter_bean_view_Index $bean) {
